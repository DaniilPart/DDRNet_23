...
class DualResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=19, planes=64, spp_planes=128, head_planes=128, augment=True):
        ...
        self.layer4 = self._make_layer(block, planes * 4, planes * 8, layers[3], stride=1)
...
def DualResNet_imagenet(cfg, pretrained=False):
    model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=cfg.DATASET.NUM_CLASSES, planes=32, spp_planes=128,
                       head_planes=64, augment=True)
    if pretrained:
